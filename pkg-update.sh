...
dirs=(smartdns luci-app-smartdns luci-app-wechatpush luci-app-chatgpt-web luci-app-filemanager luci-app-autotimeset luci-app-ddns-go luci-app-partexp luci-app-netspeedtest luci-theme-kucat luci-app-advancedplus luci-app-netwizard lucky luci-app-lucky)
