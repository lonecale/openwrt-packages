...
dirs=(smartdns luci-app-smartdns luci-app-chatgpt-web luci-theme-kucat luci-app-advancedplus luci-app-lucky luci-app-autotimeset luci-app-ddns-go luci-app-partexp luci-app-netspeedtest)
